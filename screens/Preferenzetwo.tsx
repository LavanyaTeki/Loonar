...
import {globalStyles} from '../styles/Preferenzetwostyles';
  ...
  return (
    <View>
      ...
      <View style={globalStyles.heroheader}>
        <Text style={globalStyles.auth}>Autenticazione 2FA</Text>
          ...
          <View style={globalStyles.frame27127}>
            <View style={globalStyles.PersonalDataCardOne}>
              <View style={globalStyles.frame27126}>
                <Text style={globalStyles.auths}>Autenticazione Lorem</Text>
            ...
            <View style={globalStyles.PersonalDataCardOne}>
              <View style={globalStyles.frame27126}>
                <Text style={globalStyles.other}>Other options</Text>
              </View>
            </View>
          </View>
        </View>
